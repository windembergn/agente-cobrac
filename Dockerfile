...
ENV HERMES_DASHBOARD=1     HERMES_DASHBOARD_HOST=0.0.0.0     HERMES_DASHBOARD_PORT=9119     WHATSAPP_MODE=bot     WHATSAPP_ENABLED=true     WHATSAPP_FORWARD_OWNER_MESSAGES=true     WHATSAPP_DEBOUNCE_MS=10000     WHATSAPP_DEBOUNCE_MAX_MS=60000     COPILOTO_QR_PORT=8099     HERMES_GATEWAY_BUSY_ACK_ENABLED=false
CMD ["gateway", "run"]
